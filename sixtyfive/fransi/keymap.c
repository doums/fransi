 ...
 * │Esc│ & │ é │ " │ ' │ ( │ - │ è │ _ │ ç │ ) │ * │ = │ BS    │ ~ │
 * ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─────┼───┤
 * │Tab  │ a │ z │ e │ r │ t │ y │ u │ i │ o │ p │ [ │ ] │  \  │PgU│
 * ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴─────┼───┤
 * │Ctrl  │ q │ s │ d │ f │ g │ h │ j │ k │ l │ m │ $ │ Enter  │PgD│
 * ├──────┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴────┬───┼───┤
 ...
 * │   │ ¹ │ ~ │ # │ { │ [ │ | │ ` │ \ │ ^ │ @ │   │ } │ BS    │ ¬ │
 * ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┲━┷━┳━┷━┱─────┼───┤
 * │Tab  │ à │ « │ € │ ¶ │ ŧ │ ← │ ù │ → │ ø │ þ ┃ ^ ┃ ¨ ┃  \  │PgU│  ━ dead keys
 * ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┺┯━━┻┯━━┹─────┼───┤
 * │Ctrl  │ @ │ ß │ ° │ đ │ ŋ │ ħ │   │ ĸ │ ł │ µ │ ¤ │ Enter  │PgD│
 * ├──────┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴────┬───┼───┤
 * │Shift   │ ł │ » │ ¢ │ „ │ “ │ ” │ < │ > │ · │   │Shift │ ↑ │ ≡ │
 * ├────┬───┴┬──┴─┬─┴───┴───┴───┴───┴───┴──┬┴──┬┴──┬┴──┬───┼───┼───┤
 * │ ≡  │Gui │Alt │         Space          │Alt│Gui│ ≡ │ ← │ ↓ │ → │
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT_65_ansi(
        ...
        RGB_RES, LARW,    RARW,    _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, QK_BOOT, KC_HOME,
        _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPLY, _______, KC_HOME, _______, _______, KC_END,  RARWD,   _______,          _______, KC_END,
        _______, KC_BRID, KC_BRIU, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______,          _______, _______,
        _______, _______, _______,                            _______,          _______, _______, KC_CAPS,          _______, _______, _______
    ),
    [_SL] = LAYOUT_65_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RARWD,   _______, _______,
        _______, LARW,    RARW,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
const key_override_t nolo_ko =
    ko_make_basic(MOD_MASK_GUI | MOD_MASK_SHIFT, KC_A, KC_NO); // Gui + Shift + Q sends "logout", remove it

const key_override_t *key_overrides[] = {
    &labk_ko, &rabk_ko, &circ_ko, &diae_ko, &lcbr_ko, &rcbr_ko,
    &agrv_ko, &ugrv_ko, &degr_ko, &pipe_ko, &sup2_ko, &nolo_ko,
};
